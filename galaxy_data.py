...
def delete_rows_without_images(spreadsheet_path, image_folder_path, image_extension):
    ...
    for index, row in df.iterrows():
        ...
        # Append the image extension
        img_name_with_extension = f"{img_name}.{image_extension}"

        # Check if the image name exists in the set (including the extension)
        if img_name_with_extension not in image_names_set:
...
def main():
    ...
    # spreadsheet_path = 'GZ1_dataset.csv'
    # image_folder_path = 'gz2'
    # image_extension = 'jpg'
    # delete_rows_without_images(spreadsheet_path, image_folder_path, image_extension)
